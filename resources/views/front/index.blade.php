...
<div id="header" class="bg-[#F6F7FA] relative overflow-hidden pt-20">
  <div class="container max-w-[1130px] mx-auto relative pt-10 z-10">
    ...
    <div id="Hero" class="flex flex-col gap-[30px] mt-20 pb-20">
      ...
      <div class="flex flex-col gap-[10px]">
        <!-- <h1 class="font-extrabold text-[56px] leading-[65px] max-w-[536px]"> -->
        <h1 class="font-extrabold text-[56px] leading-[65px] max-w-[56%]" data-aos="fade-up" data-aos-delay="100">
          {{$hero->heading}}
        </h1>
        <!-- <p class="text-cp-light-grey leading-[30px] max-w-[437px]"> -->
        <p class="text-cp-light-grey leading-[30px] max-w-[50%]" data-aos="fade-up" data-aos-delay="200">
          {{$hero->subheading}}
        </p>
      </div>
      <div class="flex items-center gap-4">
        ...
        <div data-aos="zoom-in" data-aos-delay="300">
          <a href=""
            class="bg-cp-dark-blue p-5 w-fit rounded-xl font-bold text-white transition-all duration-300 hover:shadow-[0_12px_30px_0_#312ECB66] hover:-translate-y-1 inline-block">
            View Projects
          </a>
        </div>
        ...
        <div data-aos="zoom-in" data-aos-delay="400">
          <button
            class="bg-cp-black p-5 w-fit rounded-xl font-bold text-white flex items-center gap-[10px] transition-all duration-300 hover:shadow-[0_12px_30px_0_#312ECB66] hover:-translate-y-1"
            onclick="{modal.show()}">
...
<div id="Clients" class="container max-w-[1130px] mx-auto flex flex-col justify-center text-center gap-5 mt-20">
  ...
  <div class="logo-container flex flex-wrap gap-5 justify-center">
    <div class="logo-card h-[68px] w-fit flex items-center shrink-0 border border-[#E8EAF2] rounded-[18px] p-4 gap-[10px] bg-white hover:border-cp-dark-blue transition-all duration-300 hover:shadow-[0_10px_30px_0_#D1D4DF80]" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="logo-card h-[68px] w-fit flex items-center shrink-0 border border-[#E8EAF2] rounded-[18px] p-4 gap-[10px] bg-white hover:border-cp-dark-blue transition-all duration-300 hover:shadow-[0_10px_30px_0_#D1D4DF80]" data-aos="fade-up" data-aos-delay="200">
      <div class="overflow-hidden h-9">
        <span class="text-lg text-black font-bold">PT. Fortuna Kontraktor</span>
      </div>
    </div>
    <div class="logo-card h-[68px] w-fit flex items-center shrink-0 border border-[#E8EAF2] rounded-[18px] p-4 gap-[10px] bg-white hover:border-cp-dark-blue transition-all duration-300 hover:shadow-[0_10px_30px_0_#D1D4DF80]" data-aos="fade-up" data-aos-delay="300">
      <div class="overflow-hidden h-9">
        <span class="text-lg text-black font-bold">PT. Imanuel Teknik Sentosa</span>
      </div>
    </div>
    <div class="logo-card h-[68px] w-fit flex items-center shrink-0 border border-[#E8EAF2] rounded-[18px] p-4 gap-[10px] bg-white hover:border-cp-dark-blue transition-all duration-300 hover:shadow-[0_10px_30px_0_#D1D4DF80]" data-aos="fade-up" data-aos-delay="400">
      <div class="overflow-hidden h-9">
        <span class="text-lg text-black font-bold">PT. Surya Sukses Maju</span>
      </div>
    </div>
    <div class="logo-card h-[68px] w-fit flex items-center shrink-0 border border-[#E8EAF2] rounded-[18px] p-4 gap-[10px] bg-white hover:border-cp-dark-blue transition-all duration-300 hover:shadow-[0_10px_30px_0_#D1D4DF80]" data-aos="fade-up" data-aos-delay="500">
      <div class="overflow-hidden h-9">
        <span class="text-lg text-black font-bold">PT. Tunggak Jati</span>
      </div>
    </div>
    <div class="logo-card h-[68px] w-fit flex items-center shrink-0 border border-[#E8EAF2] rounded-[18px] p-4 gap-[10px] bg-white hover:border-cp-dark-blue transition-all duration-300 hover:shadow-[0_10px_30px_0_#D1D4DF80]" data-aos="fade-up" data-aos-delay="600">
      <div class="overflow-hidden h-9">
        <span class="text-lg text-black font-bold">PT. Bayanaka Karya</span>
      </div>
    </div>
    <div class="logo-card h-[68px] w-fit flex items-center shrink-0 border border-[#E8EAF2] rounded-[18px] p-4 gap-[10px] bg-white hover:border-cp-dark-blue transition-all duration-300 hover:shadow-[0_10px_30px_0_#D1D4DF80]" data-aos="fade-up" data-aos-delay="700">
      <div class="overflow-hidden h-9">
        <span class="text-lg text-black font-bold">PT. EPKS</span>
      </div>
    </div>
    <div class="logo-card h-[68px] w-fit flex items-center shrink-0 border border-[#E8EAF2] rounded-[18px] p-4 gap-[10px] bg-white hover:border-cp-dark-blue transition-all duration-300 hover:shadow-[0_10px_30px_0_#D1D4DF80]" data-aos="fade-up" data-aos-delay="800">
      <div class="overflow-hidden h-9">
        <span class="text-lg text-black font-bold">PT. Duta Bangsa Mandiri</span>
      </div>
    </div>
    <div class="logo-card h-[68px] w-fit flex items-center shrink-0 border border-[#E8EAF2] rounded-[18px] p-4 gap-[10px] bg-white hover:border-cp-dark-blue transition-all duration-300 hover:shadow-[0_10px_30px_0_#D1D4DF80]" data-aos="fade-up" data-aos-delay="900">
      <div class="overflow-hidden h-9">
        <span class="text-lg text-black font-bold">PT. Vava Enviro Utama Fiberglass</span>
      </div>
    </div>
    <div class="logo-card h-[68px] w-fit flex items-center shrink-0 border border-[#E8EAF2] rounded-[18px] p-4 gap-[10px] bg-white hover:border-cp-dark-blue transition-all duration-300 hover:shadow-[0_10px_30px_0_#D1D4DF80]" data-aos="fade-up" data-aos-delay="1000">
      <div class="overflow-hidden h-9">
...
<div id="OurPrinciples" class="container max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-28">
  <div class="flex items-center justify-between">
    <div class="flex flex-col gap-[14px]">
      ...
      <h2 class="font-bold text-4xl leading-[45px]">Our Commitment to Every Project</h2>
    </div>
    <a href="" class="bg-cp-black p-[14px_20px] w-fit rounded-xl font-bold text-white transition-all duration-300 hover:shadow-[0_12px_30px_0_#312ECB66] hover:-translate-y-1 inline-block">Explore More</a>
  </div>
...
<div id="Stats" class="bg-cp-black w-full mt-24">
...
<div id="Products" class="container max-w-[1130px] mx-auto flex flex-col gap-20 mt-28">
  ...
  <div class="product flex flex-wrap justify-center items-center gap-[60px] even:flex-row-reverse"
    ...
    <div class="flex flex-col gap-[30px] py-[50px] h-fit max-w-[500px]">
      ...
      <a href="{{route('front.appointment')}}" class="bg-cp-dark-blue p-[14px_20px] w-fit rounded-xl font-bold text-white transition-all duration-300 hover:shadow-[0_12px_30px_0_#312ECB66] hover:-translate-y-1 inline-block">Book Appointment</a>
    </div>
  </div>
  @empty
  <p>Belum ada data terbaru</p>
...
<div id="Teams" class="bg-[#F6F7FA] w-full py-20 px-[10px] mt-28">
  <div class="container max-w-[1130px] mx-auto flex flex-col gap-[30px] items-center">
    <div class="flex flex-col gap-[14px] items-center">
      <p class="badge w-fit bg-cp-light-blue text-white p-[8px_16px] rounded-full uppercase font-bold text-sm">OUR PROFESSIONAL TEAM</p>
    ...
    <div class="teams-card-container grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-[30px] justify-center ">
      ...
      <div
        ...
        <div class="card bg-white flex flex-col h-full justify-center items-center p-[30px] px-[29px] gap-[30px] rounded-[20px] border border-white transition-all duration-300 hover:shadow-[0_10px_30px_0_#D1D4DF80] hover:border-cp-dark-blue hover:-translate-y-1">
      ...
      <a href="{{route('front.team')}}" class="view-all-card" data-aos="zoom-in" data-aos-delay="500">
        <div class="card bg-white flex flex-col h-full justify-center items-center p-[30px] gap-[30px] rounded-[20px] border border-white hover:shadow-[0_10px_30px_0_#D1D4DF80] hover:border-cp-dark-blue transition-all duration-300">
          ...
          <div class="flex flex-col gap-1 text-center">
            <p class="font-bold text-xl leading-[30px]">View Full Team</p>
            <p class="text-cp-light-grey">Meet More <br> Team Members</p>
          </div>
        </div>
      </a>
    </div>
...
<div id="Testimonials" class="w-full flex flex-col gap-[50px] items-center mt-28">
  <div class="flex flex-col gap-[14px] items-center">
...
<div id="Strengths" class="container max-w-[1130px] mx-auto flex flex-col gap-[30px] mt-32">
  <div class="flex items-center justify-between">
    <div class="flex flex-col gap-[14px]">
    ...
    <a href="{{route('front.appointment')}}" class="bg-cp-black p-[14px_20px] w-fit rounded-xl font-bold text-white transition-all duration-300 hover:shadow-[0_12px_30px_0_#312ECB66] hover:-translate-y-1 inline-block">
      Contact Us
    </a>
  </div>
...
<div id="FAQ" class="bg-[#F6F7FA] w-full py-20 px-[10px] mt-20 -mb-28">
    ...
    <div class="flex flex-col lg:flex-row gap-[50px] sm:gap-[70px] items-center">
      <div class="flex flex-col gap-[30px]">
        <div class="flex flex-col gap-[10px]">
          ...
          <h2 class="font-bold text-4xl leading-[45px]">Common Questions From Our Clients</h2>
        </div>
        <a href="{{route('front.appointment')}}" class="p-5 bg-cp-black rounded-xl text-white w-fit font-bold transition-all duration-300 hover:shadow-[0_12px_30px_0_#312ECB66] hover:-translate-y-1 inline-block">Contact Us</a>
      </div>
      <div class="flex flex-col gap-[30px] sm:w-[603px] shrink-0">
        <div class="flex flex-col p-5 rounded-2xl bg-white w-full">
          <button class="accordion-button flex justify-between gap-1 items-center" data-accordion="accordion-faq-1">
            <span class="font-bold text-lg leading-[27px] text-left">What services does EDBS provide?</span>
            <div class="arrow w-9 h-9 flex shrink-0 ">
              <img src="{{asset('assets/icons/arrow-circle-down.svg')}}" class="transition-all duration-300" alt="icon">
            </div>
          </button>
          <div id="accordion-faq-1" class="accordion-content hide">
            <p class="leading-[30px] text-cp-light-grey pt-[14px]">EDBS provides civil construction, building construction, industrial projects, renovation works, infrastructure support, and project management services tailored to client needs.</p>
          </div>
        </div>
        <div class="flex flex-col p-5 rounded-2xl bg-white w-full">
          <button class="accordion-button flex justify-between gap-1 items-center" data-accordion="accordion-faq-2">
            <span class="font-bold text-lg leading-[27px] text-left">Can you handle custom projects?</span>
            <div class="arrow w-9 h-9 flex shrink-0">
              <img src="{{asset('assets/icons/arrow-circle-down.svg')}}" class="transition-all duration-300" alt="icon">
            </div>
          </button>
          <div id="accordion-faq-2" class="accordion-content hide">
            <p class="leading-[30px] text-cp-light-grey pt-[14px]">Yes. Every project has unique requirements, and our team can develop customized construction solutions based on your scope, budget, timeline, and technical needs.
            </p>
            </p>
          </div>
        </div>
        <div class="flex flex-col p-5 rounded-2xl bg-white w-full">
          <button class="accordion-button flex justify-between gap-1 items-center" data-accordion="accordion-faq-3">
            <span class="font-bold text-lg leading-[27px] text-left">How do you ensure quality and safety?</span>
            <div class="arrow w-9 h-9 flex shrink-0">
              <img src="{{asset('assets/icons/arrow-circle-down.svg')}}" class="transition-all duration-300" alt="icon">
            </div>
          </button>
          <div id="accordion-faq-3" class="accordion-content hide">
            <p class="leading-[30px] text-cp-light-grey pt-[14px]">We apply structured supervision, quality control procedures, and workplace safety standards throughout every stage of the project to deliver reliable results.</p>
          </div>
        </div>
        <div class="flex flex-col p-5 rounded-2xl bg-white w-full">
          <button class="accordion-button flex justify-between gap-1 items-center" data-accordion="accordion-faq-4">
            <span class="font-bold text-lg leading-[27px] text-left">How can I request a quotation?</span>
            <div class="arrow w-9 h-9 flex shrink-0">
              <img src="{{asset('assets/icons/arrow-circle-down.svg')}}" class="transition-all duration-300" alt="icon">
            </div>
          </button>
          <div id="accordion-faq-4" class="accordion-content hide">
            <p class="leading-[30px] text-cp-light-grey pt-[14px]">You can contact our team through the Contact Us page, phone, WhatsApp, or email to discuss your project needs and receive an initial consultation.</p>
          </div>
        </div>
      </div>
    </div>
...
<button id="toTop"
  class="fixed bottom-6 right-6 hidden w-14 h-14 rounded-full bg-white text-cp-red border border-gray-200 shadow-xl z-50 hover:-translate-y-1 hover:scale-110 transition-all duration-300 flex items-center justify-center">
